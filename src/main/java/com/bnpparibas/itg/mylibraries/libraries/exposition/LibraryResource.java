...
public class LibraryResource {
    ...
    public void updateBook(@PathVariable("libraryId") String libraryId, @PathVariable("bookId") String bookId, @RequestBody LibraryDTO.BookDTO bookDTO) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void removeBookFromLibrary(@PathVariable("libraryId") String libraryId, @PathVariable("bookId") String bookId) {
